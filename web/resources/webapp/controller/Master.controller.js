/*global history */
sap.ui.define([
		"dummz/controller/BaseController",
		...
		"sap/ui/Device",
		"dummz/model/formatter",
		"dummz/model/grouper",
		"dummz/model/GroupSortState"
		...
		return BaseController.extend("dummz.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("dummz.view.ViewSettingsDialog", this);
