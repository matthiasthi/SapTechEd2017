sap.ui.define([
		...
		return BaseObject.extend("dummz.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias dummz.model.ListSelector
			 */
			 ...
			 * @return {dummz.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
